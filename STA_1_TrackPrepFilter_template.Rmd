...
* keep: band_number, animal_id, tag_id, species, *deploy_year*, deploy_site, lat_deploc, long_deploc, incl_deploy_loc, incl_recovery_loc, lat_colony, lon_colony, lat_end, lon_end, datetime_deploy_UTC, datetime_recover_UTC, collab1_point_contact_name, collab1_point_contact_email, collab1_organization, collab2_point_contact_name, collab2_point_contact_email, collab2_organization, *age*, *sex*, notes

* ask/modify: loc_data, ptt_deploy_id, datetime_start_track_UTC, datatime_end_track_UTC, file_name, observer, ptt_tagid, 

* remove: UnfilteredDataInCompiledFile, FilteredDataInCompiledFile, site_abbrev, grouping_var_1, dir1, dir2, tag_sensors, Mass_kg, Length_cm, Girth_cm, transmission duration, feather sample, blood sample, chick foraging_datetime_start_UTC, Duration, nb_locs, Species_num, Status_numb, Sex_num, Duty_cycle, Best_track, Repeat, Complete_track, Loc_num, Track_ID
...
if(Sys.info()[6]=="cahorton") {gitdir<-"C:/Users/cahorton/Documents/TelemetryAtlas/seabird_tracking_atlas-master/"}
...
Use rmarkdown PolyClip for the next steps 
