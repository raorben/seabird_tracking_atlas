...
WC_eez<-st_intersection(nc_360_NP, polygon) #cuts the eezs inside the box to the box
WC_eez<-st_difference(WC_eez, polygon_out) #cuts the eezs inside the box to the box
...
y_coord <- c(  40.4, 40,   40.650634, 40.650634, 40.4)
